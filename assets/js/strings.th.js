...
window.DDStrings = {
  ...
  "dl.hero.lead": "ฟรีและออฟไลน์ ใช้ได้ทั้งบน Windows, Android และในเบราว์เซอร์ บิลด์ Windows ด้านล่างคือแอปตัวเดียวกันทั้งหมด ต่างกันแค่ว่าเก็บข้อมูลไว้ที่ไหนและต้องติดตั้งหรือไม่",
  ...
  "dl.hero.assetsNote": "ตรงนี้คือบิลด์ Windows ส่วน Android มี<a href=\"#android\">รีลีสของตัวเองอยู่ด้านล่าง</a> และระบบปฏิบัติการอื่นรัน<a href=\"#web\">เวอร์ชันเบราว์เซอร์</a>หรือรันจากซอร์สโค้ดก็ได้ — ดู <a href=\"https://github.com/LDKTC/App-DraconDex#getting-started-desktop--dev\">Getting started</a> ใน repository",
