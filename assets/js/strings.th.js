...
window.DDStrings = {
  ...
  "home.modules.link": "อ่านเรื่องโมดูลแต่ละแบบ →",
  ...
  "home.docs.title": "เรียนรู้ว่ามันทำงานยังไง",
  "home.docs.lead": "หน้าเอกสารครอบคลุมเรื่อง Nexus กับ module tree, โมดูลทั้ง 15 แบบใช้ทำอะไร และระบบที่ใช้ร่วมกันทุกโมดูล — wikilink, ปฏิทินกำหนดเอง, แพ็กเกจ, ปลั๊กอิน, sync, สำรองข้อมูล และการเช็กอัปเดต",
  ...
  "pg.build.linkdocs": "ดูว่าปลั๊กอินเข้ากับส่วนอื่นของแอปยังไง",
  "pg.build.linktemplate": "เริ่มจากเทมเพลต",

  /* --- docs.html ---------------------------------------------------------- */
  "docs.deeper.eyebrow": "ลงลึกกว่านี้",
  "docs.deeper.lead": "ทั้งหมดข้างบนคือมุมของผู้ใช้ โปรเจกต์ยังมีชุดเอกสารเชิงเทคนิคที่ยาวกว่ามาก — สถาปัตยกรรม, พฤติกรรมของแต่ละระบบ, รายละเอียดรายไฟล์ และ changelog เต็ม เขียนเป็นภาษาไทยซึ่งเป็นภาษาหลักของโปรเจกต์ อยู่ใน repo ศูนย์กลาง",
  "docs.deeper.link": "เปิด repo ศูนย์กลาง",
  "docs.deeper.title": "ชุดเอกสารฉบับเต็ม",
  "docs.hero.lead": "DraconDex มีแนวคิดหลักอยู่อย่างเดียว: Nexus หนึ่งอันเก็บ tree หนึ่งต้น และทุก node ในนั้นเลือกได้ว่าตัวเองเป็นของแบบไหน เข้าใจตรงนี้แล้วที่เหลือตามมาเอง หน้านี้อธิบาย tree, โมดูลทั้ง 15 แบบที่ node เป็นได้ และระบบที่ใช้ร่วมกันทั้งหมด",
  "docs.hero.title": "DraconDex ทำงานยังไง",
  "docs.kind.author.realname": "หนังสือ",
  "docs.kind.author.use": "โหมด Outline ไว้จัดโครงสร้าง โหมด Reading ไว้เขียนเนื้อเรื่องจริง",
  "docs.kind.author.what": "คอลัมน์บทอยู่ซ้าย ตัวแก้ markdown อยู่ขวา",
  "docs.kind.chronicler.realname": "ไทม์ไลน์",
  "docs.kind.chronicler.use": "สร้าง timeline ให้ 1 อันตอนสร้างโมดูล และกำหนดหน่วยเวลาของตัวเองได้ — ดูหัวข้อปฏิทินกำหนดเองด้านล่าง",
  "docs.kind.chronicler.what": "เหตุการณ์บนปฏิทินที่สมมุติขึ้นเอง",
  "docs.kind.classifier.realname": "หมวดหมู่",
  "docs.kind.classifier.use": "แยกชนิด object, character และ element ออกจากกัน แต่ละ element มีหน้ารายละเอียดของตัวเองพร้อม level, เงื่อนไข และวันที่",
  "docs.kind.classifier.what": "หมวด อ็อบเจกต์ และฟิลด์ในตารางเดียวกัน — ระบบเดียวกับที่โมดูล Director เดิมใช้",
  "docs.kind.collector.realname": "โฟลเดอร์",
  "docs.kind.collector.use": "ใช้ขึ้นรูป tree เช่น collector ชื่อ “ตัวละคร” ที่เก็บโมดูลของตัวละครแต่ละตัว",
  "docs.kind.collector.what": "โฟลเดอร์เปล่า จัดกลุ่มลูกอย่างเดียว ตัวมันเองไม่มีอะไรให้เปิด คลิกได้แค่กาง/พับ",
  "docs.kind.connector.realname": "ความสัมพันธ์",
  "docs.kind.connector.use": "ให้เห็นว่าสิ่งที่เขียนถึงเชื่อมกันจริงๆ ยังไง",
  "docs.kind.connector.what": "กราฟความสัมพันธ์เหนือ filter ที่บันทึกไว้ — โหนดคือรายการ เส้นคือความสัมพันธ์และ wikilink",
  "docs.kind.designer.realname": "ผัง",
  "docs.kind.designer.use": "มี 13 รูปทรง ที่เหลืออยู่หลังปุ่ม “more”",
  "docs.kind.designer.what": "ไดอะแกรมอิสระ — รูปทรง เส้น ป้ายกำกับ ลากจัดตำแหน่งเอง",
  "docs.kind.drafter.realname": "เอกสาร",
  "docs.kind.drafter.use": "ใช้ฟิลด์คำอธิบายของโมดูลเอง จึงไม่มีอะไรให้ต้องจัดการเพิ่ม",
  "docs.kind.drafter.what": "หน้า markdown เปล่าๆ",
  "docs.kind.inspector.realname": "รายละเอียด",
  "docs.kind.inspector.use": "วิธีที่ง่ายที่สุดในการเขียนถึงของสิ่งเดียว รองรับ markdown และ [[wikilink]]",
  "docs.kind.inspector.what": "โน้ตยาวชิ้นเดียว ผูกกับฟิลด์คำอธิบายของโมดูลเอง",
  "docs.kind.locator.realname": "แผนที่",
  "docs.kind.locator.use": "วางภาพแผนที่ ลากเส้นรอบพื้นที่ แล้วผูกแต่ละพื้นที่เข้ากับโมดูล",
  "docs.kind.locator.what": "แผนที่บนแคนวาส พื้นที่หนึ่งคือ polygon ที่คุณวาดเอง",
  "docs.kind.manager.realname": "โปรเจกต์",
  "docs.kind.manager.use": "หน้าหลักของโมดูลที่มีลูก สลับมุมมองได้จากหัวแผง แอปจำการเลือกไว้แยกตามโมดูล",
  "docs.kind.manager.what": "คอนเทนเนอร์ที่แสดงลูกของโมดูลเป็น Cards, List, Table หรือ Graph",
  "docs.kind.narrator.realname": "เนื้อเรื่อง",
  "docs.kind.narrator.use": "บทสนทนา 1 ชุดคือลิสต์เรียงลำดับที่มีแถว 2 ชนิด — บทพูด กับ ตัวเลือกที่แตกเส้นทาง",
  "docs.kind.narrator.what": "กราฟบทสนทนา: โหนดกับเส้น เป็นกระดานเส้นทาง",
  "docs.kind.scribe.realname": "แชท",
  "docs.kind.scribe.use": "ไว้คิดออกมาดังๆ กับของชิ้นใดชิ้นหนึ่ง แทนที่จะเขียนเป็นโน้ตเป็นทางการ",
  "docs.kind.scribe.what": "โน้ตแบบแชทที่ผูกกับโมดูลเดียว — ฟองข้อความพร้อมเวลา",
  "docs.kind.sketcher.realname": "วาดรูป",
  "docs.kind.sketcher.use": "ไว้ร่างแผนที่หรือวาดหน้าตัวละครที่ไม่จำเป็นต้องเป็นแผนที่จริงจัง",
  "docs.kind.sketcher.what": "แคนวาสวาดมือเปล่า: ปากกา ยางลบ หลายหน้า ส่งออกเป็น PNG",
  "docs.kind.viewer.realname": "วิเคราะห์",
  "docs.kind.viewer.use": "สร้าง filter ครั้งเดียว แล้วมองมันได้ 3 มุมโดยไม่ต้องทำข้อมูลซ้ำ",
  "docs.kind.viewer.what": "เลนส์อ่านอย่างเดียวเหนือ filter ที่บันทึกไว้ ดูเป็น Table, Cards หรือ Board",
  "docs.kind.wanderer.realname": "แผนที่เวลา",
  "docs.kind.wanderer.use": "ตอบคำถามว่า “เกิดที่ไหน และตอนไหน” — เลื่อนเวลาแล้วดูหมุดขยับ",
  "docs.kind.wanderer.what": "หมุดเหตุการณ์บนแผนที่ของ Locator ผูกเวลาเข้ากับ Chronicler",
  "docs.kinds.eyebrow": "อ้างอิง",
  "docs.kinds.lead": "เลือกแบบตอนสร้างโมดูล ชื่อสีเทาข้างใต้คือชื่อที่แอปใช้เรียกในหน้าจอ ส่วนชื่อ kind คือชื่อที่เอกสารใช้เรียก",
  "docs.kinds.th.kind": "แบบ",
  "docs.kinds.th.use": "ใช้ตอนไหน",
  "docs.kinds.th.what": "คืออะไร",
  "docs.kinds.title": "โมดูลทั้ง 15 แบบ",
  "docs.meta.description": "DraconDex ทำงานยังไง — Nexus กับ module tree, โมดูลทั้ง 15 แบบใช้ตอนไหน และระบบที่ใช้ร่วมกันทุกโมดูล: wikilink, ปฏิทินกำหนดเอง, แพ็กเกจ, ปลั๊กอิน, sync, สำรองข้อมูล และการเช็กอัปเดต",
  "docs.meta.title": "เอกสาร DraconDex",
  "docs.start.eyebrow": "เริ่มต้น",
  "docs.start.note": "ไม่มีอะไรออกจากเครื่องคุณ ไม่มีบัญชี ไม่มีเซิร์ฟเวอร์ — ฟีเจอร์คลาวด์ด้านล่างเป็นแบบเลือกเปิดเอง และใช้พื้นที่เก็บของคุณเอง",
  "docs.start.step1": "<strong>ติดตั้งแล้วเปิดแอป</strong> ครั้งแรกจะถามภาษากับธีม — เปลี่ยนทีหลังได้ที่หน้าตั้งค่า",
  "docs.start.step2": "<strong>สร้าง Nexus</strong> — Nexus คือโลกหนึ่งใบ เก็บเป็นไฟล์ <code>.ddx</code> ไฟล์เดียวไว้ที่ไหนก็ได้ ปกติคือหนึ่งนิยายต่อหนึ่ง Nexus",
  "docs.start.step3": "<strong>สร้าง tree</strong> — เพิ่ม node, ตั้งชื่อ, เลือกแบบของมัน ซ้อนได้ลึกเท่าที่อยากซ้อน ไม่มีโครงสร้างสองชั้นตายตัวให้ต้องเลี่ยง",
  "docs.start.title": "สามขั้นตอนก็ใช้งานได้",
  "docs.sys.calendars.body": "ไทม์ไลน์ของ Chronicler ไม่จำเป็นต้องใช้เดือนแบบโลกจริง กำหนดหน่วยเวลาเองได้ — สัปดาห์มีกี่วัน เดือนมีกี่สัปดาห์ — แล้วกราฟ, แถบเวลา และมุมมองปฏิทินจะตามไปทั้งหมด",
  "docs.sys.calendars.title": "ปฏิทินกำหนดเอง",
  "docs.sys.drive.body": "ฟีเจอร์คลาวด์อย่างเดียวที่ต่อออกไปข้างนอก: สำรอง vault ขึ้น Drive ของคุณเอง แล้วกู้คืนทีหลังได้",
  "docs.sys.drive.title": "สำรองข้อมูลขึ้น Google Drive",
  "docs.sys.eyebrow": "ใช้ร่วมกันทั้งแอป",
  "docs.sys.more": "รายละเอียด",
  "docs.sys.packages.body": "นอกจาก 32 ธีมกับ 18 ภาษาที่มีมาให้ แอปยังติดตั้งเพิ่มจากคลังแพ็กเกจได้ ทั้งธีม คำแปล และชุดค่าการแสดงผล ที่ ตั้งค่า → ปลั๊กอิน → แพ็กเกจ",
  "docs.sys.packages.title": "ธีมและชุดภาษา",
  "docs.sys.plugins.body": "วางลิงก์ git repo แล้ว DraconDex จะแสดงให้ดูก่อนว่าปลั๊กอินประกาศจะทำอะไรบ้าง ก่อนจะเขียนอะไรลงเครื่อง แต่ละตัวได้ตารางของตัวเองและรันในหน้าต่าง sandbox แยก",
  "docs.sys.plugins.title": "ปลั๊กอิน",
  ...
  "docs.sys.vaults.title": "ไฟล์ Nexus",
  "docs.sys.wikilinks.body": "พิมพ์ <code>[[ชื่อโมดูล]]</code> ได้ทุกที่ที่รับ markdown ลิงก์ resolve ตั้งแต่ตอนพิมพ์ และของที่ถูกลิงก์ไปจะได้ backlink ชี้กลับมาเอง",
  "docs.sys.wikilinks.title": "Wikilink และ backlink",
  "docs.tree.eyebrow": "แนวคิดหลัก",
  "docs.tree.handle.body": "โมดูลไหนก็ตั้ง <code>@handle</code> สั้นๆ ได้ ห้ามซ้ำภายใน vault เดียวกัน handle คือสิ่งที่ quick switcher ค้นหา ชื่อยาวๆ จึงไม่เคยขวางทางไปถึงมัน",
  "docs.tree.handle.title": "ตั้ง handle สั้นๆ ได้",
  "docs.tree.history.body": "โมดูลเก็บประวัติเวอร์ชันไว้ และทั้งแอปมี undo ระดับ session ส่วนแท็กกับสีตัดข้าม tree ได้ เผื่อกรณีที่ลำดับชั้นไม่ใช่วิธีจัดกลุ่มที่ต้องการ",
  "docs.tree.history.title": "ไม่มีอะไรหายไป",
  "docs.tree.lead": "ทุก node คือโมดูล โมดูลมีชื่อ ไอคอน สี คำอธิบายที่เขียนด้วย markdown และ <strong>kind</strong> ที่เป็นตัวกำหนดว่าเปิดขึ้นมาแล้วเห็นอะไร node หนึ่งเก็บ node อื่นได้ ลึกเท่าไหร่ก็ได้",
  "docs.tree.pin.body": "โมดูลชั้นบนสุดปักหมุดขึ้น rail ข้างหน้าต่างได้ ของที่เปิดทุกวันจึงอยู่ห่างแค่คลิกเดียว",
  "docs.tree.pin.title": "ปักหมุดอันที่ใช้บ่อย",
  "docs.tree.title": "Nexus หนึ่งอันเก็บ tree หนึ่งต้น",
  "home.docs.tree.title": "Module tree",
  "home.docs.tree.body": "Nexus หนึ่งอันเก็บ tree หนึ่งต้น ซ้อนได้ลึกเท่าที่อยากซ้อน ทุก node เลือกเองว่าเป็นของแบบไหน",
  "home.docs.kinds.title": "โมดูล 15 แบบ",
  "home.docs.kinds.body": "แต่ละแบบคืออะไรและใช้ตอนไหน ตั้งแต่โฟลเดอร์เปล่าๆ ไปจนถึงกราฟบทสนทนา",
  "home.docs.systems.title": "ระบบที่ใช้ร่วมกัน",
  "home.docs.systems.body": "Wikilink, ปฏิทินกำหนดเอง, แพ็กเกจธีมและภาษา, ปลั๊กอิน, sync และการสำรองข้อมูล",
  "home.docs.link": "อ่านเอกสาร",
};
